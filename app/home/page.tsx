  ...
  return (
    <div className="min-h-screen flex justify-center bg-white">
      <div className="pt-8 pb-16 md:px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 bg-gradient-to-b from-[#ff7eb9] to-[#ffe6f1] p-6 rounded-lg max-w-[800px]">
          <div className="bg-white p-4 rounded-lg flex flex-col items-center w-[200px] mx-auto">
          ...
          <div className="bg-white p-4 rounded-lg flex flex-col items-center w-[200px] mx-auto col-span-1">
